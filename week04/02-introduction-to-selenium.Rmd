...
It is way easier to use firefox than Chrome. 
...
# I have skipped the switch to frame code chunks because they are not needed 
# 

agree_button <- driver$findElement(using = "xpath", value = "//button[2]/div")
...
```{r}
search_field <- driver$findElement(using = "xpath", value = "//div[2]/input")
...
```{r}
first_link <- driver$findElement(using = "xpath", value = "//div[1]/a/h3")
