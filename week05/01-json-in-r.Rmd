...
```{r}
current_dir <- "/Users/agudo07/Documents/LSE MSc Applied Social Data Science/courses/1 - MT/MY472 - DATA FOR DATA SCIENTISTS/lse-my472.github.io/week05/"
```
...
The key-value structure of JSON objects is transformed into (nested) lists in R.

Nested because the supervisor key has two sub-keys:
