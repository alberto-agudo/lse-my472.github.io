...
counts <- df %>%
  ...
  # ceiling_date function aggregates the days into months, with the final day of the month as a representation. 
...
**You can read the y values in the y-axis as log y.**
