...
We use the industrial production index because its values are issued monthly.
...
#we use drop_na after selecting so that only UK NA rows are dropped
```
...
```
In the console you can see that there are 6 groups inside the country variable.  
