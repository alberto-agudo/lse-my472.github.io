...
bribe_nodes <- html_nodes(bribe_html, css = ".paid-amount")
...
agg <- data_all %>%
  ...
  summarize(mean_bribe = mean(amount) %>% round(1)) %>% # get the summary statistics
